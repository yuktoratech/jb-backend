...
module.exports = {
  ...
  uploadImage: asyncHandler(async (req, res) => res.status(201).json(new ApiResponse(201, await service.uploadImage(req.validated.params.id, req.file, req.detectedImage, req.validated.body), 'ProductColour image uploaded successfully'))),
